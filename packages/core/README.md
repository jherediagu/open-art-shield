...
Pure TypeScript SDK for [OpenArtShield](../../README.md): invisible DCT watermarking, payload encoding with CRC-32 + repetition coding, PSNR/SSIM quality metrics, recovery metrics, and audit primitives.
